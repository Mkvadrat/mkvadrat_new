        ...
        <section class="blogs" id="blog-detail">
            <div class="blogs-wrapper">
                <div class="blogs-photo">
                    ...
                    <?php if( have_rows('main_slider_service_post_page') ){ ?>
                    <div class="blog-slider owl-carousel owl-theme">
						<?php while ( have_rows('main_slider_service_post_page') ) { the_row(); ?>
                        <div class="item-slider" style="background-image: url('<?php the_sub_field('main_image_service_post_page'); ?>');"> </div> 
						<?php } ?>
                    </div>
                    <?php }else{ ?>
